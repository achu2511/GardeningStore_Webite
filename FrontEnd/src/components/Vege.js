...
import broccoli from '../images/fresh-broccoli-vegetable-removebg-preview.png';
import tomato from '../images/one-fresh-red-tomato-isolated-white-removebg-preview.png';
import white from '../images/white-vegetable-healthy-fresh-natural-removebg-preview.png';
import capsicum from '../images/bell-pepper-removebg-preview.png';
import {Link} from 'react-router-dom';
const VegSlider = () => {
  const cardData = [
    { id: 1, title: 'Capsicum', imageUrl: capsicum },
    { id: 2, title: 'cabbage', imageUrl: white },
    { id: 3, title: 'tomato', imageUrl: tomato },
    { id: 3, title: 'broccoli', imageUrl: broccoli },

{ id: 3, title: 'capsicum', imageUrl: capsicum },
{ id: 1, title:  'cabbage' ,imageUrl: white },
